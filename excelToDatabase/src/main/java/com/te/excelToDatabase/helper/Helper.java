package com.te.excelToDatabase.helper;
...
//checking that file type is excel or not
public class Helper {
...
//convert products from excel to list of products
		...
		try {
			...
			while(cells.hasNext()) {
				...
				case 2:
					...
					break;
				case 3:
					product.setProductPrice((long)cell.getNumericCellValue());
